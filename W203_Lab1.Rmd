...
1. Normal - CHECK! 
2. i.d.d. - yes (assuming same data collection and data transformation procuedures), explain 
...
1. Ordinal variables - eyes, explain 
2. i.i.d. - yes, explain 
...
1. Democratic voters
2. Republican voters
3. DFactors contributing to difficulty in voting --> create an index?
