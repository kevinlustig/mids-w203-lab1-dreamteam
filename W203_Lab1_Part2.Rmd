...
gghistogram(sub_dem$diff_categorical, bins = 3, fill= 'steelblue', xlab='', main = 'Difficulty and Voting Status: Democrats')
```
```{r echo=FALSE,warning=FALSE}
# diff_categorical distribution for Republicans
gghistogram(sub_dem$diff_categorical, bins = 3, fill= 'steelblue', xlab='', main = 'Difficulty and Voting Status: Republicans')
```
